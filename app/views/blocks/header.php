<header class="sticky-top ntl-top">
    <nav class="py-2">
        <div class="container d-flex flex-wrap">
            <ul class="nav me-auto">
                <li class="nav-item"><a href="<?php echo _WEB_ROOT ?>/trang-chu" class="nav-link text-white px-2 active" aria-current="page">Home</a></li>
            ...
            <ul class="nav">
                <li class="nav-item"><a href="<?php echo _WEB_ROOT ?>/dang-nhap" class="nav-link text-white px-2">Login</a></li>
                <li class="nav-item"><a href="<?php echo _WEB_ROOT ?>/dang-ky" class="nav-link text-white px-2">Sign up</a></li>
            </ul>
        </div>
    </nav>
    <div class="border-bottom">
        <header class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            <div class="col-md-3 mb-2 mb-md-0">
                <a href="<?php echo _WEB_ROOT ?>/trang-chu" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
                    <img id="logo" src="<?php echo _WEB_ROOT ?>/public/assets/clients/images/logo1.png">
                </a>
            </div>
            ...
            <div class="col-md-3 text-center">
                <a href="<?php echo _WEB_ROOT ?>/gio-hang" class="col-lg-auto mb-3 mb-lg-0">
